            ...
            <div className="center">
                ...
                <div>
                    <button className="btn"
                        onClick={() => login(dispatch, 'loren')}>Login</button>
                    <button className="btn"
                        onClick={() => numberAdd2(dispatch)}>+2</button>
                    
                    <SectionTitle title="Exercício | Desafio #02" />
                    <h4>
                    #Action que multiplique por 7 #Action que divide por 25
                    #Action parseint #Action que add um número 'n'
                    </h4>
                    <button className="btn"
